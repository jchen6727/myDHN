...
# can use (EX)|(IN)|(WDR)cellRule with netpyne
# can use create(EX)|(IN)|(WDR)\(\) with netpyne or python+neuron

EXcellRule  = {
 'conds': {},
 'globals': {},
 'secLists': {},
 'secs': {'axon': {'geom': {'L': 1000.0, 'nseg': 5, 'diam': 1.0, 'Ra': 150.0, 'cm': 1.0},
                   'ions': {'k': {'e': -77.0, 'i': 54.4, 'o': 2.5},
                            'na': {'e': 50.0, 'i': 10.0, 'o': 140.0}},
                   'mechs': {'HH2': {'gnabar': 0.0, 'gkbar': 0.0, 'vtraub': -55.0},
                             'pas': {'g': 4.2e-05, 'e': -65.0}},
                   'topol': {'parentSec': 'hillock', 'parentX': 1.0, 'childX': 0.0}},
...
INcellRule  = {# was termed SG cell in prior model
 ...
 'globals': {},
 'secLists': {},
 'secs': {'axon': {'geom': {'L': 0.001, 'nseg': 50, 'diam': 0.001, 'Ra': 80.0, 'cm': 1.0},
                   'ions': {'k': {'e': -84.0, 'i': 54.4, 'o': 2.5},
                            'na': {'e': 60.0, 'i': 10.0, 'o': 140.0}},
                   'mechs': {'B_A': {},
                             'B_DR': {},
                             'B_Na': {'alpha_shift': 0.0, 'beta_shift': 0.0},
                             'KDR': {'gkbar': 0.0},
                             'KDRI': {'gkbar': 0.0},
                             'pas': {'g': 0.0, 'e': -70.0}},
                   'topol': {'parentSec': 'hillock', 'parentX': 1.0, 'childX': 0.0}},
          'dend': {'geom': {'L': 1371.0, 'nseg': 50, 'diam': 1.4, 'Ra': 80.0, 'cm': 1.0},
                   'ions': {'k': {'e': -84.0, 'i': 54.4, 'o': 2.5},
                            'na': {'e': 60.0, 'i': 10.0, 'o': 140.0}},
                   'mechs': {'B_DR': {},
                             'KDR': {'gkbar': 0.0},
...
WDRcellRule = {
 ...
 'secs': {'axon': {'geom': {'L': 1000.0, 'nseg': 5, 'diam': 1.0, 'Ra': 150.0, 'cm': 1.0},
                   ...
                   'mechs': {'HH2': {'gnabar': 0.0, 'gkbar': 0.0, 'vtraub': -55.0},
                             'pas': {'g': 0.0, 'e': -65.0}},
                   'topol': {'parentSec': 'hillock', 'parentX': 1.0, 'childX': 0.0}},
          'dend': {'geom': {'L': 350.0, 'nseg': 5, 'diam': 2.5, 'Ra': 150.0, 'cm': 1.0},
                   'ions': {'ca': {'e': 132.4579341637009, 'i': 5e-05, 'o': 2.0},
...
def createEX():
    cellRule = {
        'secs': {
                 ...
                 'axon'   : {'L': 1000, 'diam': 1.0 , 'nseg': 1 , 'Ra': 150}, #67
        },# using dlambda 0.1, freq < 100
